...
def test_recommend_by_num_common_friends(practice_graph, rj):
    assert_equals(['D', 'F'],
                  sn.recommend_by_num_common_friends(practice_graph,
                                                           "A"))
    assert_equals(['Capulet', 'Montague', 'Benvolio',
                   'Friar Laurence', 'Juliet'],
                  sn.recommend_by_num_common_friends(rj, "Mercutio"))
...
def main_test():
    ...
    test_recommend_by_num_common_friends(practice_graph, rj)
